 ...
 {
   private static Logger logger = LoggerFactory.getLogger(WebEnvironment.class);
   ...
   protected void customizePropertySources(MutablePropertySources propertySources)
   {
     try
     {
       ...
       propertySources.addLast(new MapPropertySource("applicationProperties", applicationPropertiesFactoryBean.getMap()));
     }
     catch (Exception ex)
     {
       logger.error("", ex);
